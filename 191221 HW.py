...
def test_post():
   ...
   order_receive = request.form['order_count']
   address_receive = request.form['order_address']
   phone_receive = request.form['order_phone']
   print(name_receive, order_receive, address_receive, phone_receive)

   article = {'name': name_receive, 'order': order_receive, 'address': order_address,
              'phone': order_phone}
